...
The task should be done in JavaScript and executable in an index.html file. The candidate may use any type of framework/tools. And all visual elements are up to the candidate. 
